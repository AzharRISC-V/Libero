...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\Public\Documents\Libero\Solution\Libero_Project\synthesis\top.vm"}
set_compile_info \
    -category {"Options"} \
    -name {"Limit the number of high fanout nets to display to"} \
    -value {"10"}
compile \
    -desdir {C:\Users\Public\Documents\Libero\Solution\Libero_Project\designer\top} \
    -design top \
    -fam PolarFire \
    -die PA5M300TS \
    -pkg fcg1152 \
